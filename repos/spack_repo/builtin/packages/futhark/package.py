...
class Futhark(Package):
    ...
    version("0.27.1", sha256="11248f098643487627f69695be29d96dee351a56d3f27f3715da7cf0638a0b8f")
    version("0.26.4", sha256="bd07eba4c8f2b39ed7b494bf880a3fc5fe46254cd0cabd8ca1a63e5cf240f300")
    version("0.26.3", sha256="854039fec129e2f19f89ed8402c98356f4137dcb7eecab2c604be6b510c931ee")
    version("0.26.2", sha256="e84ba282054157515186088e5cd94bf2a07d71ef2cf8408cb0997735d146f7aa")
    version("0.26.1", sha256="dd566ced0c09904ab06eb5344661aa33bf5c3d108ccf5f4b4d04179584065c9d")
    ...
    variant(
        "opencl", default=False, description="Make dependencies for the opencl backend available"
    )
    variant("cuda", default=False, description="Make dependencies for the cuda backend available")
    variant("hip", default=False, description="Make dependencies for the hip backend available")
    variant("ispc", default=False, description="Make dependencies for the ispc backend available")
